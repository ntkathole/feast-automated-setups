...
def main():
    ...
    parser.add_argument("--head-memory", type=int, default=2, help="Head memory requests (Gi)")
    parser.add_argument("--head-memory-limit", type=int, default=4, help="Head memory limits (Gi)")
