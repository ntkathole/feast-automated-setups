...
def main():
    ...
    parser.add_argument("--image", default="quay.io/modh/ray:2.35.0-py311-cu121",
                        help="Ray image")
    parser.add_argument("--workers", type=int, default=2, help="Number of workers")
    parser.add_argument("--head-cpu-requests", type=int, default=1)
    parser.add_argument("--head-cpu-limits", type=int, default=2)
    parser.add_argument("--head-memory", type=int, default=4, help="Head memory requests (Gi)")
    parser.add_argument("--head-memory-limit", type=int, default=8, help="Head memory limits (Gi)")
    parser.add_argument("--worker-cpu-requests", type=int, default=1)
    parser.add_argument("--worker-cpu-limits", type=int, default=2)
    parser.add_argument("--worker-memory", type=int, default=4, help="Worker memory requests (Gi)")
    parser.add_argument("--worker-memory-limit", type=int, default=8, help="Worker memory limits (Gi)")
